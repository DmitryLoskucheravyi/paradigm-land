    ...
    return (
        <div className="container cources-container" >
            ...
            <div className="courses-top-content">
                ...
                <p className="p-small-secondary">Ми допомагаємо дітям розвивати логічне мислення, креативність та впевненість у собі через програмування. Кожен курс адаптований під вік дитини та подається у простій і цікавій формі.</p>
            </div>
            <Swiper
                spaceBetween={16}
                slidesPerView={1}
